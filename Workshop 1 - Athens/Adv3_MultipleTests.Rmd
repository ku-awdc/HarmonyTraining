...
Can be exactly the same as the model generation code
...
Try to write a model that explicitly estimates the latent class for each individual
...
Again, this can be exactly the same as the model generation code

But convergence gets worse
