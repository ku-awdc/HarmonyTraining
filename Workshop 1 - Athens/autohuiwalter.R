## Development to auto-generate a Hui-Walter model based on partially complete observations
# Written by Matt Denwood for Hefin Williams 2019-05-16
# Is now part of the development version of runjags
