...
You need to install R (version 3.6.0 or later) from https://cran.r-project.org/ and we recommend that you also use Rstudio which can be downloaded separately from https://www.rstudio.com/products/rstudio/download/

Please also install the latest versions of the following R packages:  PriorGen, rjags, runjags, coda, TeachingDemos, HSROC, MCMCpack, mada
